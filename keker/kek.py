...
default_values = '''checker:       
 ...
 # Profit calculator for if you have a shop or sell your accounts:
  ...
  RPC:
                # Set true if you want to flex KEK on people, this will only work with the discord APP not the webbrowser
...
class Main:
    def __init__(self):
        ...
        windll.kernel32.SetConsoleTitleW(
            f'KEKChecker coded by Gabs | Main menu')
 ...
 |_|\_\______|_|\_\  \_____|_|  |_|______\_____|_|\_\______|_|  \_\
...
'''
        ...
        if not Checker.auto_login:
            print(self.t)
            print(f'''
{Fore.GREEN}|{Fore.WHITE}Welcome to KEK Checker
...
''')
            ...
            if mod == "1":
                ...
                if login_status == 0:
                    ...
                    print(
                        f'{Fore.RED}|{Fore.LIGHTWHITE_EX}This tool was coded by {Fore.GREEN}gabs.#0001 who cant code for shit lmao')
                    print(
                ...
                if register_status == 0:
                    ...
                    try:
                        with requests.Session() as sess:
                            ...
                            response_3 = "success"
                            flag3 = 'KEK checker sucks'
                            if flag3:
                                if "success" in response_3:
                                    print(
                                        "\n{}, Welcome To KEKchecker".format(username))
                                    time.sleep(2)
                                    system('cls')
                                else:
        ...
        if self.version == lastver:
            ...
            if Checker.RPC.discordrpc:
                ...
                rpc.update(large_image='large',
                           large_text='KEKchecker', state='In the menu')
                if Checker.RPC.rpcd:
                    print('RPC set successfully.')
            system('cls')
            windll.kernel32.SetConsoleTitleW(
                f'kekChecker coded by Gabs{self.version} | Select A mode')
            print(self.t)
        print(f'''
...
''')
        ...
        if mode == "4":
            ...
            print(self.t)
            windll.kernel32.SetConsoleTitleW(
                f'KEKChecker Coded By Gabs | Module: ProxyChecker')
            ...
            def proxy_check(proxy):
                ...
                try:
                    ...
                    if 'URI' in r:
                        ...
                        rpc.update(large_image='large', large_text='KEKchecker', state='Checking | KEKproxy',
            ...
            if __name__ == '__main__':
                ...
                windll.kernel32.SetConsoleTitleW(
                    f'KEKChecker coeded by Gabs | Starting | KEKproxy')
                if Checker.RPC.discordrpc:
                    rpc.update(large_image='large', large_text='KEKchecker', state='Checking Proxies | KEKproxy',
                               details=f'Unbanned: {Counter.mojangunbanned} Bad: {Counter.invalid}')
                ...
                print(self.t)
                windll.kernel32.SetConsoleTitleW(
                    f'KEKChecker-{self.version} Done Checking | KEKproxy')
                if Checker.RPC.discordrpc:
                    rpc.update(large_image='large', large_text='KEKchecker', state='Done Checking | KEKproxy',
                               details=f'Unbanned: {Counter.mojangunbanned} Bad: {Counter.invalid}')
                    if Checker.RPC.rpcd:
                        print('Updated RPC')
            ...
            PORT = 25565
            windll.kernel32.SetConsoleTitleW(
                f'KEKchecker V{self.version} | Module: BanChecker')
            ...
            if __name__ == '__main__':
                ...
                print(self.t)
                windll.kernel32.SetConsoleTitleW(
                    f'KEKChecker-{self.version} Asking a few questions | BanChecker')
                flag = True
                while (flag):
                    print(f'{Fore.MAGENTA}')
                    alts_file = input(
                ...
                print(self.t)
                if Checker.RPC.discordrpc:
                    rpc.update(large_image='large', large_text='KEKchecker',
                               state='Checking | BanChecker', details=f'Server: {SERVER} |  Retries: {RETRIES}')
                    if Checker.RPC.rpcd:
                        print('Updated RPC')
                windll.kernel32.SetConsoleTitleW(
                    f'KEKChecker-{self.version} | Checking | BanChecker')
                ...
                for result in as_completed(tasks):
                    print(result.result())
                windll.kernel32.SetConsoleTitleW(
                    f'KEKChecker-{self.version} | Done Checking | BanChecker')
                print('Finished!\n')
                mode = input('Press ENTER to get back to the menu')
                import os
                system('cls')
                os.system('"kekchecker.exe"')

        elif mode == "5":
            system('cls')
            print(self.t)
            windll.kernel32.SetConsoleTitleW(
                f'KEKchecker V{self.version} | Module: ComboEditor')
            print(f'''
{Fore.GREEN}|{Fore.WHITE}OPTIONS:
...
''')
            ...
            if Checker.RPC.discordrpc:
                rpc.update(large_image='large', large_text='KEKchecker',
                           details=' Scraping Proxies | KEKProxy')
                if Checker.RPC.rpcd:
                    print('Updated RPC')
            windll.kernel32.SetConsoleTitleW(
                f'KEKChecker-{self.version} | Scraping Proxies | KEKProxy')
            ...
            while True:
                ...
                if len(urls) > 0:
                    ...
                    break
            windll.kernel32.SetConsoleTitleW(
                f'KEKChecker-{self.version} | Done Scraping | KEKProxy')
            if Checker.RPC.discordrpc:
                rpc.update(large_image='large', large_text='KEKchecker',
                           details=' Done Scraping | KEKProxy')
            ...
            if __name__ == '__main__':
                windll.kernel32.SetConsoleTitleW(
                    f'KEKchecker V{self.version} | Module: MailAccess')
                system('cls')
                print(self.t)
                mailfile = input(
        ...
        print(f'{Fore.MAGENTA}[KEKchecker] Starting Threads...\n')
        windll.kernel32.SetConsoleTitleW(
            f'KEKChecker-{self.version} | Getting ready!')
        ...
        def updaterpc():
            while True:
                rpc.update(large_image='large', large_text='KEKchecker', state='Checking Accounts',
    ...
    def names(self):
        ...
        async def pause(ctx):
            ...
            if ctx.message.author.id in users:
                if not self.Paused:
                    ...
                    self.prints(f'{Fore.MAGENTA}[KEKchecker] Checking Paused')
                else:
        ...
        async def resume(ctx):
            ...
            if ctx.message.author.id in users:
                if self.Paused:
                    ...
                    self.prints(
                        f'{Fore.MAGENTA}[KEKchecker] Checking Resumed')
                else:
        ...
        async def stats(ctx):
            ...
            if ctx.message.author.id in users:
                ...
                await ctx.send('**Thank you for using KEKChecker**')
